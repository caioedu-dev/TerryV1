...
Meu objetivo é fornecer respostas rápidas, claras e objetivas sobre programação, tecnologia, cibersegurança, redes, bancos de dados, sistemas operacionais e diversos outros assuntos.

Também posso sugerir cursos, desafios, projetos, e acompanhar sua evolução através do sistema de níveis.
...
O Terry é um chat bot desenvolvido em Python para responder perguntas sobre programação, tecnologia, cibersegurança, redes, hardware, sistemas operacionais e diversos outros assuntos. 

Seu banco de conhecimento pode ser expandido facilmente através do arquivo respostas.txt.
